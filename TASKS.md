...
*В условии сказано: "Если ошибки были — необходимо вывести номера строк (номера начинаются с 1, выведите их через пробел), соответствующей песни". В действительности для того, чтобы ответ был засчитан, если ошибки были, необходимо вывести номера строк песен, в которых музыкант __не ошибся__.*
